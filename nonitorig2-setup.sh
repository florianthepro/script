#!/usr/bin/env bash
# https://start.1password.com/open/i?a=OBRSLWYUBNF7FEXAKRRAOGKGGI&v=m5j2jegcaz6rzuxa2c6lhwemd4&i=t35fqzdwvma3zp5df4ffxesrfu&h=tanum.1password.com
set -euo pipefail
...
Exec=${CHROMIUM_BIN} --kiosk --incognito --noerrdialogs --disable-translate --disable-infobars --check-for-update-interval=31536000 --password-store=basic --no-first-run --no-default-browser-check "${DASHBOARD_START_URL}"

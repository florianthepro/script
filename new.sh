...
# =========================
# Pakete installieren (nur was gebraucht wird)
# =========================

apt-get update

# (libnss3-tools / certutil nicht mehr nötig, da wir CA nicht mehr einspielen)
# Nur noch Browser- und Kiosk-Tools:
...
# =========================
# LightDM Autologin (falls vorhanden)
# =========================

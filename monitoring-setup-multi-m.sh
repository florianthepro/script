...
# Benutzer für den Kiosk-Betrieb
KIOSK_USER="dash"

# PRTG-Dashboard (primäres Dashboard)
...
# Zweites Dashboard (optional)
# Beispiel: "https://monitoring.tcsoc.net/public/mapshow.htm?ids=..."
MY_DASHBOARD_URL=""

# Anzeigezeiten in Sekunden, bevor gewechselt wird
PRTG_DASHBOARD_URL_S=60   # wie lange Dashboard 1 gezeigt wird
MY_DASHBOARD_URL_S=60     # wie lange Dashboard 2 gezeigt wird

# Pfad zum Root-CA-Zertifikat
CA_CERT_PATH="/usr/local/share/ca-certificates/tanum_root_CA.crt"

# Bildschirm-Ein-/Ausschaltzeiten (Mo–Fr)
SCREEN_ON="08:00"
SCREEN_OFF="19:00"
...
# =========================
# Kiosk-User anlegen (falls nötig)
# =========================

if ! id -u "${KIOSK_USER}" >/dev/null 2>&1; then
  echo "Kiosk-Benutzer ${KIOSK_USER} existiert nicht, wird erstellt..."
  # ohne Passwort, da nur für Autologin/Kiosk genutzt
...
# =========================
# Dashboard-Rotation (optional 2. Dashboard)
# =========================
...
Exec=${CHROMIUM_BIN} --kiosk --incognito --noerrdialogs --disable-translate --disable-infobars --check-for-update-interval=31536000 "${DASHBOARD_START_URL}"
